...
apiRouter.get("/profiles/:username/posts", userController.ifUserExists, userController.apiGetPostsByUsername);
apiRouter.get("/profiles/:username/followers", userController.ifUserExists, userController.profileFollowers);
apiRouter.get("/profiles/:username/following", userController.ifUserExists, userController.profileFollowing);
